...
export default function OrderHistoryAdmin() {
  ...
  const getTotalPrice = (element) => {
    let initialSum = 0;
    let finalSum = 0;
    element.orderItems.map(
      (item) => (initialSum = initialSum + item.quantity * item.price)
    );
    finalSum = initialSum;
    initialSum = 0;
        ...
        <div class="orderhistory-main">
          <div>
            <div class="orderhistory-searchbar">
              ...
              <Searchbar
                tempText="Search Orders By Name/email/Mobile"
            ...
            {message.length > 1 ? (
              <h5 style={{ margin: 10, color: "grey", fontStyle: "Italic" }}>
                {message}
              </h5>
            ) : null}
                    ...
                    <div key={index} class="orderdiv">
                        ...
                        <div class="orderer-outer">
                          <div class="orderer">
                            <Row>
                              ...
                              <Col>
                                <p>Total Price: {getTotalPrice(element)} LKR</p>
                              </Col>
                              <Col>
                                {" "}
                                <p>
                      ...
                      <Accordion.Body>
                        ...
                        <Row>
                          ...
                          <Col>{getTotalPrice(element)} LKR</Col>
                        </Row>
                        <>
                          {element.status !== "Delivered" &&
                          element.status !== "Cancelled" ? (
                            ...
                            >
                              ...
                              <Dropdown.Menu>
                                <Dropdown.Item
                                  onClick={() => changeStatus(element.id, 1)}
                                >
                                  Processing
                                </Dropdown.Item>
                                <Dropdown.Item
                                  onClick={() => changeStatus(element.id, 2)}
                                >
                                  Delivered
                                </Dropdown.Item>
                                <Dropdown.Item
                                  onClick={() => changeStatus(element.id, 3)}
                                >
                                  Cancel
                                </Dropdown.Item>
                              </Dropdown.Menu>

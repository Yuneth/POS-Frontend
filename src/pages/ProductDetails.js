    ...
    <>
      {loader ? (
        ...
        <div style={{ marginTop: 100 }} class="details-body">
          <img
            class="details-img"
            src={config.IMAGE_BASE_URL + "" + product.productPhoto}
          />
          <div>
            ...
            <h3 style={{ display: "block" }}>{product.productPrice} LKR</h3>
            <div style={{ color: "orange", fontSize: "2rem" }}>
              <AiFillStar
                onClick={() => alert("Rated 1")}
                style={{ cursor: "pointer" }}
              />
              <AiFillStar
                onClick={() => alert("Rated 2")}
                style={{ cursor: "pointer" }}
              />
              <AiFillStar
                onClick={() => alert("Rated 3")}
                style={{ cursor: "pointer" }}
              />
              <AiOutlineStar
                onClick={() => alert("Rated 4")}
                style={{ cursor: "pointer" }}
              />
              <AiOutlineStar
                onClick={() => alert("Rated 5")}
                style={{ cursor: "pointer" }}
              />
            </div>
            <div class="cartdiv">
              {rollType != 500 ? (
                <>
                  ...
                  />
                  {!product.quantity ? (
                    <button onClick={validate} class="addtocart">
                      Add to cart
                    </button>
                  ) : (
                    <button onClick={validate} class="addtocart">

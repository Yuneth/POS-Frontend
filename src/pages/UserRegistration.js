      ...
      <div class="registration-form">
        ...
        <div class="input-container">
          <div style={{ width: "93%", display: "flex" }}>
            <input
              class="registration-inputs"
              style={{ color: "black", width: "90%", marginRight: 0 }}
              type={pass}
              value={password}
              onChange={(e) => {
            ...
            />
            <div
              style={{ width: "10%", marginLeft: 0, color: "black" }}
              type="checkbox"
              onClick={() => {
                if (pass == "password") {
                  showPass("text");
            ...
            >
              {pass == "password" ? (
                <img
                  src={require("../Images/open.jpg")}
                  alt=""
                  style={{ height: "20px", width: "20px", cursor: "pointer" }}
                />
              ) : (
                <img
                  src={require("../Images/close.jpg")}
                  alt=""
                  style={{
                    height: "20px",
                    width: "20px",
        ...
        <div style={{ width: "25vw", margin: "auto" }}>
          <button onClick={validate} class="button-main ">
            Sign Up
          </button>
        </div>
      </div>

            ...
            <div class="homemain">
              ...
              <div class="actionbar">
                ...
                <div class="bar-list-button-div">
                  ...
                  <div class="bar-list-button-div">
                    {grid ? (
                      <div class="show-bar-btn" onClick={() => setGrid(false)}>
                        <AiOutlineMenu /> List View
                      </div>
                    ) : (
                      <div class="show-bar-btn" onClick={() => setGrid(true)}>
                        <BiGridSmall /> Grid View
                      </div>
                    )}
                  </div>
                </div>
              ...
              {actionBar ? (
                <div class="filter-actions">
                  <Row>
                    <Col>
                      <SortByPrice onClick={findByPrice} />
                    </Col>
                    <Col>
                      <SortProducts onPress={sortProducts} />
                    </Col>
                    <Col>
                      <FilterProducts onPress={getproductsbycatid} />
                    </Col>
                  </Row>
                </div>
              ) : null}
                          ...
                          <>
                            ...
                            >
                              ...
                              <div class="card-body">
                                <h4 class="card-title">
                                  {" "}
                                  {trimLine(element.productName, 17)}...
                                </h4>
                                <h4 class="card-text">

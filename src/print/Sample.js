    ...
    return (
        ...
        <div class="orderdiv-bill" style={{ marginBottom: 30 }}>
                        <div class="orderer-bill">
                            ...
                            <Row>
                                <Col><p>Total Price: {getTotalPrice(element)} LKR</p></Col>
                            </Row>
                            <Row>
                        ...
                        {element.orderItems.map((item, index) => (
                            ...
                            <Row key={index} style={{ height: 50 }}>
                                <Col>{item.name}</Col>
                                <Col>{item.price}{' LKR'}</Col>
                                <Col>{item.quantity}</Col>
                                <Col>{item.quantity * item.price}{' LKR'}</Col>
                            </Row>
))}
<Row>
    <Col aria-colspan={4}>Total :{getTotalPrice(element)} LKR</Col>
</Row>
                    </div>
